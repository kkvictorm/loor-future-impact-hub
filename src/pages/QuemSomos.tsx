      ...
      <section className="bg-white section-padding">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-8">
            <div>
              <h3 className="text-xl font-semibold mb-4 text-loor-blue">O que é o LOOR</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-loor-blue">Operação Regulada CVM</h3>
              <p className="mb-4 text-gray-700">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-semibold mb-4 text-loor-blue">Investimento Próprio</h3>
            <p className="text-gray-700">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center">
              ...
              <h3 className="font-heading font-semibold text-xl mb-4">Missão</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center">
              <Target className="text-loor-green h-12 w-12 mb-4" />
              <h3 className="font-heading font-semibold text-xl mb-4">Visão</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center text-center">
              <Heart className="text-loor-green h-12 w-12 mb-4" />
              <h3 className="font-heading font-semibold text-xl mb-4">Valores</h3>
